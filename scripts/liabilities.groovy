...
def objectName='LoanApplicantLiabilities_c'
def key = Id.toString()          
def loanService = adf.webServices.LoanDataService
loanService.requestHTTPHeaders=loanDataheaders 
def queryParms = [:] 
queryParms.expand='CreditAndStoreCardCollection_c,HomeAndInvestmentPropertyLoaCollection_c,OtherLoanCollection_c,PersonalLoanCollection_c'
